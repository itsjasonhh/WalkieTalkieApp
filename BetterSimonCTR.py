#code taken from https://github.com/inmcm/Simon_Speck_Ciphers/blob/master/Python/simonspeckciphers/simon/simon.py
...
class SimonCipher(object):
    ...
    def __init__(self, key, key_size=256, block_size=128, mode='CTR', init=0, counter=0):
        """
